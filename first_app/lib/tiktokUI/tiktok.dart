    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.people,color: Colors.white,), label: 'Friends'),
          BottomNavigationBarItem(
              ...
              label: ''),
          BottomNavigationBarItem(icon: Icon(Icons.inbox,color: Colors.white,), label: 'Inbox'),
      ...
      body: Column(
        children: <Widget>[
          Container(child: Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,
            children: <Widget>[Icon(Icons.live_tv, size: 44,),
          ...
          Container(child: Container(child: Text('hello', style: GoogleFonts.abel(),),),
